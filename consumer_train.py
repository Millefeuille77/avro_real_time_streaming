...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"]="D:\IYKRA\Week_9_Avro_Schema_Registry\bitcoin_practice\json_bigquery.json"

dataset_name = 'bitcoin'
table_name = 'stream_bitcoin_price_training'
...
def read_messages():
    ...
    consumer.subscribe(["practice_testing_2"])
